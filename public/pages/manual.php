<?php
/**
 * Manual/Downloads Page - Korean Version
 * Integrated with database in Phase 2
 */
require_once __DIR__ . '/../includes/db.php';

// Fetch Korean Manuals from database
...
<div id="MANUAL_IMG">
    <div id="MANUAL">
    	<img src="/public/assets/images/manual_img.png"/>
    </div>
</div>
<!--TOP IMG 영역 끝-->
<!-- top영역끝 -->
...
<div id="SUBMENU">
    ...
    <ul class="smenu">
        ...
        <li class="smenu_basic"><a href="manual.html"><strong>자료실</strong></a>
        	<ul class="sub">
...
<div id="manual_board">
	<div id="manual_container">
	        ...
	        <div id="manual_area">
       		 <div id='module_board' class='him_module' rel='manual'><!-- 게시판 스타일시트 -->
...
총 게시물 <b><?php echo $totalManuals; ?></b>개
        </td>
        <td align="right">
			<div id="searcher">
    ...
    <tr>
        <td align="center" style="padding-top:10px">
            <table class="tbl-paging">
                <tr>
                    <td>
                        <a href="manual8c08.html?bbs_id=manual&amp;m=list&amp;p=1&amp;search_category="><img src="/public/assets/img/paging_first.png"></a><a href="manual8c08.html?bbs_id=manual&amp;m=list&amp;p=1&amp;search_category="><img src="/public/assets/img/kr/paging_prev.png"></a>
                    </td>
                    <td class="page">
                            <a href="manual8c08.html?bbs_id=manual&amp;m=list&amp;search_category=&amp;p=1" class="page selected" >1</a>
                    </td>
                    <td><a href="manual8c08.html?bbs_id=manual&amp;m=list&amp;p=1&amp;search_category="><img src="/public/assets/img/kr/paging_next.png"></a><a href="manual8c08.html?bbs_id=manual&amp;m=list&amp;p=1&amp;search_category="><img src="/public/assets/img/paging_last.png"></a></td>
                </tr>
            </table>
        </td>
    </tr>
...
var bl = {
	...
	view:function(seq, is_manager) {
		if (is_manager==1) {
			document.location.href='?m=view&bbs_id=manual&p=1&search_category=&seq='+seq;
        }
